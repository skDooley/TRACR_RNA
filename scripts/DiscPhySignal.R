...
ratematrix <- function(pi,rho){
  ...
  if (k==6){
    r <- c(pi[1]*0     , pi[2]*rho[1], pi[3]*rho[2],  pi[4]*rho[3],  pi[5]*rho[4],  pi[6]*rho[5],
           pi[1]*rho[1], pi[2]*0     , pi[3]*rho[6],  pi[4]*rho[7],  pi[5]*rho[8],  pi[6]*rho[9],
           pi[1]*rho[2], pi[2]*rho[5], pi[3]*0     ,  pi[4]*rho[10], pi[5]*rho[11], pi[6]*rho[12],
           pi[1]*rho[3], pi[2]*rho[6], pi[3]*rho[9],  pi[4]*0,       pi[5]*rho[13], pi[6]*rho[14],
           pi[1]*rho[4], pi[2]*rho[7], pi[3]*rho[10], pi[4]*rho[12], pi[5]*0,       pi[6]*rho[15],
           pi[1]*rho[5], pi[2]*rho[8], pi[3]*rho[11], pi[4]*rho[13], pi[5]*rho[14], pi[6]*0)
           
  }
  if (k==7){
    r <- c(pi[1]*0     , pi[2]*rho[1],  pi[3]*rho[2],  pi[4]*rho[3],  pi[5]*rho[4],  pi[6]*rho[5],   pi[7]*rho[6],
           pi[1]*rho[1], pi[2]*0     ,  pi[3]*rho[7],  pi[4]*rho[8],  pi[5]*rho[9],  pi[6]*rho[10],  pi[7]*rho[11],
           pi[1]*rho[2], pi[2]*rho[7],  pi[3]*0     ,  pi[4]*rho[12], pi[5]*rho[13], pi[6]*rho[14],  pi[7]*rho[15],
           pi[1]*rho[3], pi[2]*rho[8],  pi[3]*rho[12], pi[4]*0,       pi[5]*rho[16], pi[6]*rho[17],  pi[7]*rho[18],
           pi[1]*rho[4], pi[2]*rho[9],  pi[3]*rho[13], pi[4]*rho[16], pi[5]*0,       pi[6]*rho[19],  pi[7]*rho[20],
           pi[1]*rho[5], pi[2]*rho[10], pi[3]*rho[14], pi[4]*rho[17], pi[5]*rho[19], pi[6]*0,        pi[7]*rho[21],
           pi[1]*rho[6], pi[2]*rho[11], pi[3]*rho[15], pi[4]*rho[18], pi[5]*rho[20], pi[6]*0*rho[21],pi[7]*0)
